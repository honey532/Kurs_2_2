...
переходим на сайт  https://github.com/digininja/DVWA (рис. [-@fig:001])

![001](image/1.png){#fig:001 width=70%}


начинаем устоновку (рис. [-@fig:002])

![002](image/2.png){#fig:002 width=70%}



создаём пользователя (рис. [-@fig:003])

![003](image/3.png){#fig:003 width=70%}



взходим в акаунт (рис. [-@fig:004])(рис. [-@fig:005]).
