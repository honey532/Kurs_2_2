...
написать код для реализации Однократное гаммирование


# Выполнение лабораторной работы

мой код для для реализации Однократное гаммирование(рис. [-@fig:001]).

![001](image/1.png){#fig:001 width=70%}


пример шифрования (рис. [-@fig:002]).

![002](image/2.png){#fig:002 width=70%}



пример расшифрования (рис. [-@fig:003]).

![003](image/3.png){#fig:003 width=70%}



пример нахождения ключа(рис. [-@fig:004]).
